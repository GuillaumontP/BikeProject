...
class Visualization(object):
    ...
    def __init__(self):
        ...
        title_widget = widgets.HTML(
            ...
            '<h4> size of circles growing every 150 bikers</h4>'
    ...
    def update_date(self,b):
        ...
        day2 = ('0' + str(day))[-2:] # add 0 artificially 
        month2 = ('0' + str(month))[-2:]
        Compt, dateofday = self.data()
        
        nb_days = sum(np.array(dateofday) < '2020-' + month2 + '-' + day2) # carefull to First 0 index
        for i in range(10):
            self.Gsymbols.markers[i].scale = round(Compt[i][nb_days]/150) + 1
    ...
    def _render_control(self):
        ...
        self.button = widgets.Button( description = "Visualize Date")
        self.button.on_click(self.update_date)
        controls = widgets.VBox([self.FloatSlider1, self.FloatSlider2, self.button])
